...
export const DEFAULT_OUTPUT_VOLUME_CALIBRATION: Readonly<OutputVolumeCalibration> = Object.freeze({
  noiseFloor: 0,
  gain: 4,
  exponent: 0.8,
  attack: 1,
...
/**
 * Meters a browser audio track without transferring ownership of that track.
 * The returned meter owns only its AudioContext and timer.
 */
